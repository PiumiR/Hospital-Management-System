...
public class Ppharmacy extends javax.swing.JFrame {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, JpanelLayout.createSequentialGroup()
                        ...
                        .addGroup(JpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(JpanelLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(idMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(280, 280, 280))
                    .addGroup(JpanelLayout.createSequentialGroup()
                        .addGap(498, 498, 498)
            ...
            .addGroup(JpanelLayout.createSequentialGroup()
                ...
                .addGroup(JpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, JpanelLayout.createSequentialGroup()
                        ...
                        .addComponent(idMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(JpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(JpanelLayout.createSequentialGroup()
                        .addGap(28, 28, 28)
                        .addGroup(JpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            String sqlc="select ph.User_Id ,ph.Price from pharmacybill ph,patient p  where ph.User_Id=p.User_Id and p.phone = ? order by  ph.User_Id desc limit 1 ";
            
            PreparedStatement retrievec = conn.prepareStatement(sqlc);
            retrievec.setInt(1,Integer.parseInt(phone.getText()));
            ...
            else if(resultc.next()==false){
                JOptionPane.showMessageDialog(this,"No pharmacy bill is issued to this number!!");
            }
            else{
            ...
            String sql2="select ph.User_Id ,ph.Price from pharmacybill ph,patient p  where ph.User_Id=p.User_Id and p.phone = ? order by  ph.User_Id desc limit 1 ";
